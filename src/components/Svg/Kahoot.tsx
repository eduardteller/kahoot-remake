const Kahoot = () => {
  return (
    <svg
      ...
      version="1.1"
      fill="currentColor"
      className="h-full flex-1 text-purple-700"
    >
      <defs>
